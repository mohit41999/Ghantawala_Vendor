...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void initState() {
    ...
    if (_update) {
      ...
      _product.availableTimeStarts = Get.find<AuthController>()
          .profileModel
          .restaurants[0]
          .availableTimeStarts;
      _product.availableTimeEnds = Get.find<AuthController>()
          .profileModel
          .restaurants[0]
          .availableTimeEnds;
    }
                      ...
                      children: [
                            ...
                            fieldViewBuilder:
                              ...
                              return Container(
                                ...
                                child: TextField(
                                  ...
                                  focusNode: node,
                                  onEditingComplete: (widget.product != null)
                                      ? () {}
                                      : () {
                                          onComplete();
                                          controller.text = '';
                        ...
                        Row(children: [
                          Expanded(
                            ...
                            onTimeChanged: (time) => (widget.product != null)
                                ? () {}
